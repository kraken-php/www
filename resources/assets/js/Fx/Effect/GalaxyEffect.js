 ...
 *
 * Based on http://codepen.io/kenchen/pen/tgBiE
 */
!function(a,b) {
    "use strict";
...
//                            }
                ...
                a.addEventListener("resize", function(){ k(); j(); }, !1);
...
//                            console.log(5);
                            ...
                            //G || (t = window.requestAnimationFrame(j))
//
//                            G || (t = window.setTimeout(j, 100));
            }
        }
